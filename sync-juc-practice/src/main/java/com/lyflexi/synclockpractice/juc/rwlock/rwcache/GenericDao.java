...
public class GenericDao {
    static String URL = "jdbc:mysql://192.168.18.100:3306/juc?characterEncoding=utf-8&useSSL=false";
    static String USERNAME = "root";
    static String PASSWORD = "root";

    public <T> List<T> queryList(Class<T> beanClass, String sql, Object... args) {
        System.out.println("execute db sql: [" + sql + "] params:" + Arrays.toString(args));
